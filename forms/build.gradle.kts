...
kotlin {
    ...
    androidLibrary {
        namespace = "com.helloanwar.mvvmate.forms"
...
mavenPublishing {
    ...
    pom {
        name.set("CMP Forms Library for MVVM state management")
        description.set("This library is a companion forms validation library for MVVM state management")
